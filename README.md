...
This is the most important setting to get right. The Canny algorithm uses two thresholds to identify "strong" and "weak" edges.
...
So for your available kernel sizes:
...
Recommended Sigma Values for Your Scenery Image
...
2. For Balanced Results (most common use case)
Kernel Size: 5 (σ ≈ 0.67) ⭐ RECOMMENDED STARTING POINT
